...
# https://github.com/villagaiaimpacthub/sparc
...
sudo mkdir -p /usr/local/sparc/{bin,claude-commands}
...
# Create the complete sparc-init script (the working 37KB version)
...
echo "📚 Documentation: https://github.com/villagaiaimpacthub/sparc"
echo