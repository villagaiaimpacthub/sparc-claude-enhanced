...
DROP TABLE IF EXISTS sparc_contexts CASCADE;
...
CREATE INDEX idx_project_memorys_project_id ON project_memorys(project_id); -- Legacy
CREATE INDEX idx_sparc_contexts_namespace ON sparc_contexts(namespace);
CREATE INDEX idx_sparc_contexts_project_id ON sparc_contexts(project_id); -- Legacy
CREATE INDEX idx_agent_tasks_namespace ON agent_tasks(namespace);
CREATE INDEX idx_agent_tasks_project_id ON agent_tasks(project_id); -- Legacy
...
CREATE INDEX idx_agent_executions_project_id ON agent_executions(project_id); -- Legacy
CREATE INDEX idx_approval_queue_namespace ON approval_queue(namespace);
CREATE INDEX idx_approval_queue_project_id ON approval_queue(project_id); -- Legacy
